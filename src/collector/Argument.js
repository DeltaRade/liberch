...
class Argument {
	 ...
	 * @returns {Promise<{canceled:boolean,value:discord.Channel|discord.User|discord.GuildMember|discord.Message|string|discord.Role}>}
	 */
		...
		if (collector && collector.size) {
			...
			if (!value) {
				await message.channel.send(
					this.errorMsg ||
						'It seems, that this is not the correct answer!'
				);
